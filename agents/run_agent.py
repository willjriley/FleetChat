...
def claude_reply(cfg, persona, context, session_id=None, state=None):
    ...
    prompt = ("You are in a live team chat. Recent messages:\n\n" + context +
              ...
              "plainly. If you're about to repeat or agree with a claim someone else in the chat "
              "made, check it against the messages above yourself first -- don't just echo it because "
              "it was already said. The crew shares a TASK BOARD at " + board_url + "/threads : GET lists cards; "
